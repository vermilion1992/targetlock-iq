...
- Add or import features, components, or modules from the main system into the starter kit
- Reuse existing logic and structure to extend the starter setup
- Maintain consistency between core and starter configurations
- follow this path for prompts `prompts/integration/`
