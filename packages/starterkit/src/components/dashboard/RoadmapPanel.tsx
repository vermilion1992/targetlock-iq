  ...
  return (
    <>
      <AdvancedTabHero
        ...
        title="Roadmap"
        copy="RC1 delivers validated browser-based decision support. Offline field mode and live integrations are planned separately — informational only, not committed delivery dates."
      />
