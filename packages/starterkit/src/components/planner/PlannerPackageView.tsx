...
export function PlannerLimitationsPanel() {
  return (
    <PlannerSubPanel
      className="planner-limitations-panel"
      kicker="Package"
  ...
  return (
    <div className="planner-package-view">
      <AdvancedTabHero
        ...
        copy="Grouped exports for contractors, geologists, and execution handoff."
      />

      <div className="planner-package-groups">
        <PlannerSubPanel kicker="Package" title="Coordinate exports">
        ...
        <PlannerSubPanel kicker="Package" title="Program package">
          <p className="targetlock-panel-copy">
          ...
          <PlannerActionGroup>
            <button
              ...
              disabled={!programId}
              onClick={() =>
                programId && onExportProgramPackage(programId, programName ?? "program")
              }
            >
            ...
            <button
              ...
              disabled={!programId}
              onClick={() =>
                programId && onExportProgramPdf(programId, programName ?? "program")
              }
            >
              Planning PDF
            </button>
            <button
              ...
              disabled={!programId}
              onClick={() =>
                programId && onExportProgramTxt(programId, programName ?? "program")
              }
            >
              Planning TXT
            </button>
        ...
        {selectedHole ? (
          <PlannerSubPanel
            kicker="Package"
            title={`Selected hole — ${selectedHole.holeName}`}
          >
            <PlannerActionGroup>
              <button
                type="button"
          ...
          <PlannerSubPanel kicker="Package" title="Selected hole">
            <p className="targetlock-panel-copy">
        ...
        {activeHoles.length > 0 && !selectedHole ? (
          <PlannerSubPanel kicker="Package" title="Execution evidence">
            {activeHoles.map((h) => (
              <ExecutionEvidenceSection
                key={h.holeId}
                hole={h}
